...
<div class="mt-8 ">
    ...
    Welcome to your Zones application!
...
<!-- 
          ...
          @foreach($zones as $zone)
            ...
            <tr>
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">{{ $zone->address }}</div>
                <div class="text-sm text-gray-500">{{ $zone->use }}</div>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                {{ $zone->zone_id }}
...
@endif
            ...
            <x-jet-danger-button wire:click="confirmTPDeletion({{ $zone->id }})" wire:loading.attr="disabled">
                {{ __('Delete') }}
            </x-jet-danger-button>
              </td>
            </tr>
